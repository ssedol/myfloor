  ...
  return (
    ...
    >
      ...
      <Section heading="제6조 (광고의 게재)">
        <p>
          서비스는 무료 운영을 위해 Google AdSense, 카카오 애드핏 등 제3자 광고를 화면에 게재합니다.
          광고의 내용과 광고주와의 거래는 해당 광고 사업자 및 광고주의 책임이며, 운영자는 광고를 통해
          연결된 외부 사이트의 상품·서비스에 대해 책임지지 않습니다. 광고 관련 쿠키 처리는{" "}
